    ...
    animate() {
        ...
        if (this.group) {
            ...
            if (this.edgeLine) {
                ...
                this.edgeLine.material.opacity += (to - this.edgeLine.material.opacity) * 0.1;
            }
        }
...
class LayerScene {
    ...
    setExplodeProgress(p) { this.targetProgress = Math.max(0, Math.min(1, p)); }
...
class DegradationScene {
    ...
    animate() {
        ...
        if (this.particles) {
            ...
            this.particles.material.opacity = this.progress * 0.6;
        ...
        // Sprouts
        this.sprouts.forEach((sp, i) => {
            const gs = 0.4 + i * 0.1;
            const gp = Math.max(0, (this.progress - gs) / (1 - gs));
            sp.material.opacity = gp;
            sp.scale.y = gp;
